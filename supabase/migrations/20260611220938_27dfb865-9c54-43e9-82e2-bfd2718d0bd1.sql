...
GRANT SELECT, INSERT, DELETE ON public.audio_likes TO authenticated;
GRANT ALL ON public.audio_likes TO service_role;
GRANT SELECT, INSERT, DELETE ON public.audio_saves TO authenticated;
GRANT ALL ON public.audio_saves TO service_role;
