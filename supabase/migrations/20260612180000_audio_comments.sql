-- Comentarios en audios. Lectura pública (cualquiera ve los comentarios);
-- solo el autor autenticado puede crear o borrar los suyos.
...
-- Mantener audios.comments sincronizado (solo audios reales con id UUID)
